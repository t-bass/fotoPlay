export class Overlay {
  ...
  constructor(params) {
    ...
    if (!Array.isArray(this.classes)) {
      throw new TypeError('Дополнительный класс может быть задан только в виде массива');
    }

    this.styles = params?.styles ?? this.styles;

    if (typeof this.styles !== 'object') {
      throw new TypeError('Дополнительные стили могут быть заданы только в виде объекта');
    }
  }
  /**
